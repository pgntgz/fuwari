...
const diaryData: DiaryItem[] = [
  ...
  },
  {
    id: 17,
    content:
      "不是一个专业程序员的情况下运营博客还是挺那个的，我还是受不了Mizuki的性能了，现在是回归主线了。新的域名是18号买的。说实话确实好看啊。考虑到topSEO太差，而且内容方面的风险，到底还是妥协了，这次干脆连域名一起也给迁过来了，本月的文章计划看来又要推迟了。几天要把剩下的项目啥的也给搬到新的域名。",
    date: "2026-08-23T21:39",
  },
];
